...
\title{
    \vspace{-2cm}
    \large Національний університет\\
    \large \medskip
    \textbf{Лабораторний проєкт 3}\\
    \medskip
    \large Курс: Операційні системи \\
    \medskip
    \textbf{\Large Синхронізація процесів}\\
    \medskip
    {\large Варіант 2: автомат розміну монет, алгоритм Деккера}
}
\author{}
\date{}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.95\textwidth]{../screenshots/01-startup.png}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.95\textwidth]{../screenshots/02-automode.png}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.95\textwidth]{../screenshots/04-manual-deal.png}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.95\textwidth]{../screenshots/05-manual-refuse.png}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.95\textwidth]{../screenshots/03-nosync-collisions.png}
