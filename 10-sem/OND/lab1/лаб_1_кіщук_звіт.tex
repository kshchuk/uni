...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.72\textwidth]{figures/circles_xi_eta.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.72\textwidth]{figures/ellipses_xy.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.85\textwidth]{figures/portrait_1.png}
    \caption{Фазовий портрет для Завдання 3 (центр)}
\end{figure}

\begin{figure}[H]
    \centering
    \includegraphics[width=0.78\textwidth]{figures/solve3.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.72\textwidth]{figures/hyperbolas_xi_eta.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.72\textwidth]{figures/saddle_curves_xy.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.85\textwidth]{figures/portrait_2.png}
    \caption{Фазовий портрет для Завдання 6 (сідло)}
\end{figure}

\begin{figure}[H]
    \centering
    \includegraphics[width=0.78\textwidth]{figures/solve6.png}
    \caption{Скріншот аналітичного розв'язку у Maple для Завдання 6}
\end{figure}

\begin{figure}[H]
    \centering
    \includegraphics[width=0.85\textwidth]{photos/telegram-cloud-photo-size-2-5411135133827404541-y.jpg}
    \caption{Рукописний розв'язок Завдання~3 (інша частина загубилась)}
\end{figure}

\begin{figure}[H]
    \centering
    \includegraphics[width=0.85\textwidth]{photos/telegram-cloud-photo-size-2-5411135133827404543-y.jpg}
    \caption{Рукописний розв'язок Завдання~6}
\end{figure}

\begin{figure}[H]
    \centering
    \includegraphics[width=0.85\textwidth]{photos/telegram-cloud-photo-size-2-5411135133827404547-y.jpg}
