...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.72\textwidth]{figures/local_M1.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.72\textwidth]{figures/local_M2.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.72\textwidth]{figures/local_M3.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.82\textwidth]{figures/global_phase_portrait.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.85\textwidth]{figures/maple_deplot.png}
...
На рис.~\ref{fig:ext37_view1} наведено побудову у розширеному фазовому просторі $(x,y,t)$: інтегральні криві системи~\eqref{eq:system} зображено як тривимірні траєкторії, у яких вісь $t$ показує час проходження стану. Пунктирні вертикальні лінії відповідають особливим точкам $M_1$, $M_2$, $M_3$ (вони стаціонарні вздовж часу). Візуалізація виконана на Python (\texttt{plotly}, інтерактивний 3D).

\begin{figure}[H]
    \centering
    \includegraphics[width=0.95\textwidth]{\detokenize{screenshots/Screenshot 2026-04-20 at 23.09.51.png}}
    \caption{Розширений фазовий простір для системи~\eqref{eq:system}, ракурс 1}
    \label{fig:ext37_view1}
\end{figure}

\begin{figure}[H]
    \centering
    \includegraphics[width=0.95\textwidth]{\detokenize{screenshots/Screenshot 2026-04-20 at 23.10.27.png}}
    \caption{Розширений фазовий простір для системи~\eqref{eq:system}, ракурс 2}
    \label{fig:ext37_view2}
\end{figure}

\begin{figure}[H]
    \centering
    \includegraphics[width=0.95\textwidth]{\detokenize{screenshots/Screenshot 2026-04-20 at 23.11.29.png}}
    \caption{Розширений фазовий простір для системи~\eqref{eq:system}, ракурс 3}
    \label{fig:ext37_view3}
\end{figure}

\begin{figure}[H]
    \centering
    \includegraphics[width=0.95\textwidth]{\detokenize{screenshots/Screenshot 2026-04-20 at 23.11.58.png}}
    \caption{Розширений фазовий простір для системи~\eqref{eq:system}, ракурс 4}
    \label{fig:ext37_view4}
\end{figure}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.85\textwidth]{photos/telegram-cloud-photo-size-2-5418129556788416924-y.jpg}
    \caption{Сторінка 1: запис системи, пошук особливих точок, вивід лінеаризації через ряд Тейлора}
\end{figure}

\begin{figure}[H]
    \centering
    \includegraphics[width=0.85\textwidth]{\detokenize{photos/2026-04-19 22.35.26.jpg}}
    \caption{Сторінка 2: слід, визначник, лінеаризована система; точка $M_1(2,1)$ --- нестійкий вузол, власні числа та власні вектори}
\end{figure}

\begin{figure}[H]
    \centering
    \includegraphics[width=0.85\textwidth]{\detokenize{photos/2026-04-19 22.35.45.jpg}}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.85\textwidth]{\detokenize{photos/2026-04-19 22.35.49.jpg}}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.65\textwidth]{figures/local_M1_3_6.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.65\textwidth]{figures/local_M2_3_6.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.9\textwidth]{figures/global_phase_portrait_3_6.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\textwidth]{\detokenize{screenshots/Screenshot 2026-04-19 at 22.07.40.png}}
...
На рис.~\ref{fig:ext36_view1} показано інтегральні криві системи~\eqref{eq:system36} у розширеному фазовому просторі $(x,y,t)$. Сітку стартових точок інтегровано у прямому та зворотному часі; часова вісь $t$ додає до стандартного фазового портрета інформацію про те, коли саме траєкторія проходить той чи інший стан. Пунктирні вертикальні лінії відповідають особливим точкам $M_1(1,1)$ і $M_2(-1,-1)$, а горизонтальні пунктири на площині $t=t_{\min}$ --- межі $y=\pm\sqrt{2}$ області означення. Візуалізація виконана на Python (\texttt{plotly}, інтерактивний 3D).

\begin{figure}[H]
    \centering
    \includegraphics[width=0.95\textwidth]{\detokenize{screenshots/Screenshot 2026-04-20 at 23.13.02.png}}
    \caption{Розширений фазовий простір для системи~\eqref{eq:system36}, ракурс 1}
    \label{fig:ext36_view1}
\end{figure}

\begin{figure}[H]
    \centering
    \includegraphics[width=0.95\textwidth]{\detokenize{screenshots/Screenshot 2026-04-20 at 23.13.38.png}}
    \caption{Розширений фазовий простір для системи~\eqref{eq:system36}, ракурс 2}
    \label{fig:ext36_view2}
\end{figure}

\begin{figure}[H]
    \centering
    \includegraphics[width=0.95\textwidth]{\detokenize{screenshots/Screenshot 2026-04-20 at 23.14.14.png}}
    \caption{Розширений фазовий простір для системи~\eqref{eq:system36}, ракурс 3}
    \label{fig:ext36_view3}
\end{figure}

\begin{figure}[H]
    \centering
    \includegraphics[width=0.95\textwidth]{\detokenize{screenshots/Screenshot 2026-04-20 at 23.23.35.png}}
    \caption{Розширений фазовий простір для системи~\eqref{eq:system36}, ракурс 4}
    \label{fig:ext36_view4}
\end{figure}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.85\textwidth]{\detokenize{photos/2026-04-19 22.37.34.jpg}}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.85\textwidth,angle=90]{\detokenize{photos/2026-04-19 22.37.38.jpg}}
