...
\subsection{Лінеаризація в околі $M_1(2,1)$}
...
\begin{figure}[H]
    ...
    \caption{Локально біля $M_2(1,2)$ (сідло): траєкторії, поле напрямків, криві $\dot{x}=0$, $\dot{y}=0$, наближені сепаратриси}
\end{figure}
...
\begin{figure}[H]
    ...
    \caption{Локально біля $M_2(-1,-1)$ (сідло): траєкторії, поле напрямків, криві $\dot{x}=0$, $\dot{y}=0$ і наближені сепаратриси}
\end{figure}
