...
\begin{center}
\vspace*{4cm}
{\Large\bfseries Словничок термінів та основних понять\\[0.4em] з математичної нелінійної оптимізації}\\[1.5cm]
{\normalsize на основі матеріалу лекцій Джалладової І.~А.\\ та посібника М.~П.~Моклячука\\[0.3em] \emph{«Негладкий аналіз та оптимізація»}}\\[2.5cm]
{\large Виконав: Кіщук Ярослав}\\[0.6cm]
