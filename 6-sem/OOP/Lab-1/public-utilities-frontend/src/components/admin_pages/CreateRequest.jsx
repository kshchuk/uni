...
const CreateRequest = () => {
    ...
    const getIds = async() => {
        const tenantIdsResp = await axios.get(SET_URL, {
            params: {
                field: "tenants",
                value: "tenants"
            },
        ...
        console.log(JSON.stringify(tenantIdsResp?.data));
        setTenantIds(tenantIdsResp?.data);
    }
    ...
    return (
        <section>
            ...
            <p>You can create new requests</p>
